  ...
  return (
    <section id="application-form" className="bg-[#FAF7F0] px-7 py-[60px]">
      <div className="rounded-[10px] border border-[rgba(201,168,76,0.25)] bg-white px-6 py-8">
        ...
        <div className="expert-badge mb-7 flex items-center gap-2.5 rounded-md border border-[rgba(201,168,76,0.3)] bg-[#F5EDD6] px-[14px] py-3">
          <div className="expert-avatar flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#0D1B2A]">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          <div className="expert-info min-w-0">
            <strong className="block break-keep text-[12px] font-bold text-[#0D1B2A]">
              전문 보험설계사가 직접 확인합니다
            </strong>
